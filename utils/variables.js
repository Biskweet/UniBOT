...
export const twitterAccounts = ["SU", "SULettres", "SUMédecine", "SUPolytech"];
...
export const eightBallAnswers = ["C'est certain.", 
                                 ...
                                 "Il y a peu de chance.s",
                                 "J'en doute.",
                                 "C'est non.",
                                 "Négatif.",
                                 "N'y pense même pas."];

export const WikiLocales = ['en', 'fr', 'de', 'es', 'ja', 'ru', 'it', 'zh', 'pt', 'ar', 'fa', 'pl', 'nl', 'id', 'uk', 'he', 'sv',
